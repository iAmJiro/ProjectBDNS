    ...
    <div className="lg:container lg:mx-auto lg:py-16 md:py-12 md:px-6 py-12 px-4">
      ...
      <div className="lg:w-8/12 w-full mx-auto">
        ...
        <div className="w-full md:px-6">
          ...
          >
            <p className="text-base leading-6 text-gray-600 font-normal">
              Currently, we offer pick-up only for all orders. Our cakes can be
              picked up from our Wairarapa location.
            </p>
          </div>
        </div>
        ...
        <div className="w-full md:px-6">
          ...
          >
            <p className="text-base leading-6 text-gray-600 font-normal">
              You can place an order by contacting us through our website or by
              giving us a call. We'll guide you through the process and help you
