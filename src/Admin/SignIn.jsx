        ...
        <div className="w-full max-w-md bg-gradient-to-r from-purple-500 to-purple-700 rounded-lg shadow-md p-6">
          ...
          <form className="flex flex-col" onSubmit={LoginHandler}>
            <input
              ref={usernameInput}
              type="text"
              className="bg-gray-100 text-gray-900 border-0 rounded-md p-2 mb-4 focus:bg-gray-200 focus:outline-none focus:ring-1 focus:ring-black transition ease-in-out duration-150"
            ...
            <button
              type="submit"
              className="bg-gradient-to-r from-purple-800 to-purple-500 text-white font-bold py-2 px-4 rounded-md mt-4 hover:bg-black hover:to-gray-700 transition ease-in-out duration-150"
            >
              Login
            </button>
          </form>
