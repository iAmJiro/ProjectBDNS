    ...
    <>
      ...
      >
        <div className="container mx-auto my-10 text-center">
          <h1 className="md:text-5xl text-4xl font-bold dark:text-white mb-4 min-h-full">
            Products
          </h1>

          <p className="text-gray-600 mx-4 dark:text-white md:text-2xl text-xl mb-12">
      ...
      <div className="container mx-auto my-8">
        ...
        {Object.keys(groupedImages).map((categoryName) => (
          <div key={categoryName} className="mb-10">
            {/* Category Title */}
            <h2 className="md:text-4xl text-3xl dark:text-white  mt-8 font-bold mb-6 text-center">
              {categoryName}
            </h2>
            <div className="grid grid-cols-1 lg:grid-cols-4 mx-8 gap-4">
